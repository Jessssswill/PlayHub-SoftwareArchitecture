...
export const patterns: Pattern[] = [
  ...
  },
  {
    ...
    intent: 'TicTacToeFactory, ChessFactory, dan ConnectFourFactory masing-masing memproduksi board, rules, dan initial state yang kompatibel.',
  ...
  },
  {
    ...
    category: 'Structural',
    name: 'Proxy (Cache)',
    intent: 'CachedGameStateProxy meng-cache hasil getState() dengan TTL 1 detik dan auto-invalidate saat move.applied diterima.',
